    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-start px-6 sm:px-12 md:px-20 lg:px-28 z-10">
        <h1 className="overflow-hidden">
          <span ref={titleRef1} className="block text-[2.25rem] sm:text-[3rem] md:text-[3.75rem] lg:text-[4.5rem] leading-tight tracking-tight text-[#14b8a6] opacity-0" style={{ fontFamily: "'Playfair Display', serif" }}>
            Bhubaneswar's
          </span>
          <span ref={titleRef2} className="block text-[2.25rem] sm:text-[3rem] md:text-[3.75rem] lg:text-[4.5rem] leading-tight tracking-tight text-[#14b8a6] opacity-0" style={{ fontFamily: "'Playfair Display', serif" }}>
            Ultimate Healthcare.
          </span>
        </h1>
      ...
      <div 
        className={`fixed sm:absolute top-28 right-0 sm:right-4 md:right-[40px] z-20 w-[180px] transition-transform duration-300 ease-out sm:translate-x-0 sm:block ${sidebarOpen ? 'translate-x-0 block' : 'translate-x-full hidden sm:hidden'}`}
      >
