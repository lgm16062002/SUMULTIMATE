    ...
    >
      ...
      <div className="w-full mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start">
          ...
          <div className="px-4 sm:px-8 lg:px-[60px] py-2 lg:py-1 lg:ml-[40px] flex items-center justify-between lg:justify-start gap-3">
            <img
              src="/sum-logo.png"
              alt="Logo"
              className="h-[70px] sm:h-[82px] lg:h-[90px] w-auto object-contain"
            />
            {/* Mobile / tablet menu icon (shown only on small/medium) */}
            <button
              type="button"
              className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-transparent text-black hover:bg-black/5 transition lg:hidden"
          ...
          <div className="right-content w-full hidden lg:block">
            <div className="flex top-bar relative z-0 flex-col sm:flex-row sm:justify-between bg-gradient-to-r from-[#006d77] to-[#00334e] px-4 sm:px-[15px] rounded-bl-[9px] text-white pb-2 sm:pb-[10px] gap-1 sm:gap-0" style={{ paddingRight: '100px' }}>

              <div className="text-[11px] sm:text-[13px] opacity-90 leading-[24px] sm:leading-[28px]">
            ...
            <div className="px-4 sm:p-[15px] pb-2 sm:pb-[8px]">
              ...
              <div className="text-black font-medium text-[12px] sm:text-[13.5px] uppercase whitespace-normal lg:whitespace-nowrap flex items-center flex-wrap tracking-wide z-10 gap-y-2">
                <a
